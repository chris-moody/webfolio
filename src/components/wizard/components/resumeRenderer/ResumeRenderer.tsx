    ...
    <>
      ...
      >
        <Typography variant="body1" className="info">
          <Link title="Call Me" href="tel:+19172257503" mr={{ xs: 2, md: 0 }}>
            {isMobile ? (
              <IconButton>
                <CallIcon />
              </IconButton>
          ...
          <Link
            title="Email Me"
            target="_blank"
            href="mailto:chris@moodydigital.com"
          >
            {isMobile ? (
              <IconButton>
                <AlternateEmailIcon />
      ...
      <StyledResume>
        ...
        <Box className="section">
          <Typography variant="h4">Biolumina, New York City, NY</Typography>
          <Typography variant="body1" className="roles">
            Freelance Software Development Engineer, 03/2025-Present; Remote
            off-site
          </Typography>
          <Typography variant="body1" component="li">
            Thrived in a fast-paced healthcare agency environment with shifting
            scope, tight deadlines, and regulated review cycles
          </Typography>
          <Typography variant="body1" component="li">
            Built reusable UI frameworks across Vue/React/vanilla JS to
            accelerate delivery for teams and AI-assisted workflows.
          </Typography>
          <Typography variant="body1" component="li">
            Built a dedicated Node.js/Express middle-layer (Electron-wrapped) to
            act as a backend-for-frontend for the UI, simplifying releases and
            standardizing how the app integrated with downstream services and
            assets.
          </Typography>
        </Box>
        <Box className="section">
          ...
          <Typography variant="body1" className="roles">
            Principal Software Engineer, 08/2017-02/2025; Remote off-site
          </Typography>
          <Typography variant="body1" component="ul">
            <Typography variant="body1" component="li">
              Architected and evolved the company&rsquo;s primary React web app
              from greenfield to a production, enterprise-scale, multi-tenant
              SaaS platform serving all client organizations for data delivery
              and analysis.
            </Typography>
            <Typography variant="body1" component="li">
              Developed and maintained a shared UI framework to enforce
              consistency and accelerate delivery across three engineering
              teams; reduced duplicated UI implementation effort by ~30%
            </Typography>
            <Typography variant="body1" component="li">
              Drove UI performance and reliability improvements through deep
              debugging with Chrome DevTools, Lighthouse, and AI-assisted
              workflows (profiling, tracing, and audit-driven fixes), preventing
              recurring production issues.
            </Typography>
            <Typography variant="body1" component="li">
              Designed a comprehensive testing strategy using Jest and Cypress;
              established E2E and unit test coverage standards and patterns that
              improved release confidence and reduced regressions across the
              platform
            </Typography>
            <Typography variant="body1" component="li">
              Authored technical documentation, UML diagrams, and optimization
              roadmaps; identified and prioritized technical debt
            </Typography>
            <Typography variant="body1" component="li">
              Fostered an open and collaborative environment by encouraging
              curiosity around the unknown, and discussion around challenges
            </Typography>
          </Typography>
        </Box>
